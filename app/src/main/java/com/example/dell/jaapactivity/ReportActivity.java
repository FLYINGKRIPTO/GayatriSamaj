...
public class ReportActivity extends AppCompatActivity  implements DatePickerDialog.OnDateSetListener,NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*   rDb.addUserReportData(new ReportData("Jap","Jan","21","Tue",4,2.6f,"Atam Bodh Dhayan","with Pujya Gurudev"));
        ...
        */
        ...
        pastThirtyDataSet.setColors(ColorTemplate.MATERIAL_COLORS);
   ...
   /* public void  showDialogBox(Activity activity, String title, final CharSequence message) {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if (id == R.id.all_reports) {
            ...
            Intent reportsIntet = new Intent(ReportActivity.this, ReportActivity.class);
            startActivity(reportsIntet);
        }
        if (id == R.id.japInMenu) {
            Intent japIntent = new Intent(ReportActivity.this, JapActivity.class);
            startActivity(japIntent);

        }
        if (id == R.id.meditationInMenu) {
            Intent medIntent = new Intent(ReportActivity.this, MeditationActivity.class);
            startActivity(medIntent);

        }
        if (id == R.id.swadhyayInMenu) {
            Intent intent = new Intent(ReportActivity.this, Swadhyay.class);
            startActivity(intent);
        }
        if (id == R.id.yagyaInMenu) {
            Intent intent = new Intent(ReportActivity
                    .this, YagyaActivity.class);
            startActivity(intent);
        }
